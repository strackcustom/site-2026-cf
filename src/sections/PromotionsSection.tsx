                                ...
                                <CarouselItem key={image.src} className="basis-full">
                                    <div className="p-1">
                                        <div
                                            ...
                                            onClick={() => onImageClick(image.src.startsWith('/') ? `${import.meta.env.BASE_URL}${image.src.substring(1)}` : image.src, image.alt)}
                                        >
                                            <div className="aspect-[4/3] sm:aspect-[16/9] w-full flex items-center justify-center">
                                                <img
                                                    src={image.src.startsWith('/') ? `${import.meta.env.BASE_URL}${image.src.substring(1)}` : image.src}
                                                    alt={image.alt}
